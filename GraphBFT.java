...
public class GraphBFT
{
	...
	protected Queue<Vertex> q = new Queue<Vertex>();
	...
	public void BFT(Vertex source) {
		...
		while (current.nextUnvisitedNeighbour() != null) {
			q.enqueue(current.nextUnvisitedNeighbour());
			output.add(current.nextUnvisitedNeighbour());
			current.nextUnvisitedNeighbour().markVisited();
		}
